package santhosh.pm.ormorange.query;
...
public class Select<T> implements Iterable {
    ...
    public Cursor getCursor() {
       return OrangeORMRecord.getCursor(record, whereClause, arguments, groupBy, orderBy, limit);
    }
    public List<T> list() {
        if (arguments == null) {
        ...
        return OrangeORMRecord.find(record, whereClause, arguments, groupBy, orderBy, limit);
    }
    ...
    public long count() {
        ...
        return OrangeORMRecord.count(record, whereClause, arguments, groupBy, orderBy, limit);
    }
    ...
    public T first() {
        ...
        List<T> list = OrangeORMRecord.find(record, whereClause, arguments, groupBy, orderBy, "1");
    ...
    public Iterator<T> iterator() {
        ...
        return OrangeORMRecord.findAsIterator(record, whereClause, arguments, groupBy, orderBy, limit);
    }
