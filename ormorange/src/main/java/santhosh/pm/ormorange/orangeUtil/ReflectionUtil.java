...
import santhosh.pm.ormorange.annotations.Ignore;
...
import santhosh.pm.ormorange.helper.MultiDexHelper;
...
public class ReflectionUtil {
    ...
    public static List<Field> getTableFields( Class table) {
        List<Field> fieldList = OrangeORMConfig.getFields(table);
        ...
        OrangeORMConfig.setFields(table, toStore);
        return toStore;
    }
    ...
    public static void addFieldValueToColumn( ContentValues values, Field column, Object object,
        ...
        try {
            ...
            } else if (OrangeORMRecord.class.isAssignableFrom(columnType)) {
                values.put(columnName,
                        (columnValue != null)
                                ? String.valueOf(((OrangeORMRecord) columnValue).getId())
                                : "0");
            } else {
    ...
    public static void setFieldValueFromCursor( Cursor cursor, Field field, Object object) {
        ...
        try {
            ...
            if (columnIndex < 0) {
                if (ManifestHelper.isDebugEnabled()) {
                    Log.e("ORANGE", "Invalid colName, you should upgrade database");
                }
                return;
            }
    ...
    private static Class getDomainClass(String className) {
        ...
        if ((discoveredClass != null) &&
                ((OrangeORMRecord.class.isAssignableFrom(discoveredClass) &&
                        !OrangeORMRecord.class.equals(discoveredClass)) ||
